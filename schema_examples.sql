...
INSERT INTO `e-learning`.`users` (`role`,`e-mail`,`first_name`,`last_name`,`password`) VALUES ('student', 'example3@asd.com', 'Georgi', 'Georgiev', 'password123');
INSERT INTO `e-learning`.`users` (`role`,`e-mail`,`first_name`,`last_name`,`password`) VALUES ('teacher', 'example4@asd.com', 'Anton', 'Antonov', 'password123');
